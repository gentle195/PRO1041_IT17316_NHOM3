...
public class HoaDonDuAN {
    ...
    public HoaDonDuAN(String idHD, String idKH, String idNV, String idPT, String Ma, String NgayTao, String NgayThanhToan, String NgayShip, String NgayNhan, String tenNgNhan, String diaChi, String sdt, int TinhTrang) {
        this.idHD = idHD;
        this.idKH = idKH;
        this.idNV = idNV;
        this.idPT = idPT;
